...
('DV001', N'Nước suối', 20000, N'Thực phẩm', N'Chai 500ml', N'Chai'),
('DV002', N'Ăn sáng', 50000, N'Thực phẩm', N'Buffet', N'Suất'),
('DV003', N'Giặt ủi', 100000, N'Tiện ích', N'Gói giặt ủi', N'Lần');
