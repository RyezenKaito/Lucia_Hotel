...
public class DatPhongView extends BorderPane {
    ...
    private VBox buildTable() {
        ...
        table.setRowFactory(tv -> {
            ...
            row.setOnMouseEntered(e -> { if (!row.isEmpty()) row.setStyle("-fx-background-color: #f0f4ff;"); });
            ...
            miEdit.setOnAction(e -> { Object[] r = row.getItem(); if (r != null) openEditDialog(r); });

            MenuItem miDelete = new MenuItem("🗑 Xóa đơn đặt phòng");
            miDelete.setStyle("-fx-font-size: 13px; -fx-text-fill: #dc2626;");
            miDelete.setOnAction(e -> { Object[] r = row.getItem(); if (r != null) confirmDelete(r); });
        ...
        TableColumn<Object[], String> colMaDat  = col("Mã đặt", 0, 100);  colMaDat.setStyle("-fx-alignment: CENTER;");
        TableColumn<Object[], String> colTenKH  = col("Khách hàng", 1, 160);
        TableColumn<Object[], String> colSDT    = col("SĐT", 2, 110);     colSDT.setStyle("-fx-alignment: CENTER;");
        TableColumn<Object[], String> colPhong  = col("Phòng", 3, 90);    colPhong.setStyle("-fx-alignment: CENTER;");
        TableColumn<Object[], String> colIn     = col("Ngày nhận", 4, 105);colIn.setStyle("-fx-alignment: CENTER;");
        TableColumn<Object[], String> colOut    = col("Ngày trả", 5, 105); colOut.setStyle("-fx-alignment: CENTER;");
        TableColumn<Object[], String> colNguoi  = col("Số người", 6, 75);  colNguoi.setStyle("-fx-alignment: CENTER;");
        TableColumn<Object[], String> colCoc    = col("Tiền cọc", 7, 110); colCoc.setStyle("-fx-alignment: CENTER-RIGHT;");
        ...
        colStatus.setCellFactory(c -> new TableCell<>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                String bg, fg;
                switch (item) {
                    case "DANG_O" -> { bg = "#d1fae5"; fg = "#065f46"; }
                    case "DA_TRA" -> { bg = "#f3f4f6"; fg = "#6b7280"; }
        ...
        table.getColumns().addAll(colSTT, colMaDat, colTenKH, colSDT, colPhong, colIn, colOut, colNguoi, colCoc, colStatus);
    ...
    public void loadData() {
        ...
        try (Connection con = ConnectDatabase.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                String checkOut = rs.getDate("ngayCheckOut") != null ? rs.getDate("ngayCheckOut").toLocalDate().format(FMT) : "—";
    ...
    private void applyFilter(String keyword) {
        ...
        if (keyword == null || keyword.isBlank()) {
            ...
            filteredData.setPredicate(row ->
                    ((String) row[0]).toLowerCase().contains(lower) ||
