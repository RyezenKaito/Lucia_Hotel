...
public class InvoiceExporter {
    ...
    public static String exportToHTML(HoaDon hd, List<Object[]> dsPhong) {
        ...
        html.append(
                "<p><b>Ngày lập:</b> " + (hd.getNgayTaoHD() != null ? hd.getNgayTaoHD().format(FMT) : "—") + "</p>\n");
        html.append("<p><b>Nhân viên:</b> " + (hd.getNhanVien() != null ? hd.getNhanVien().getHoTen() : "System")
                + "</p>\n");
        html.append("</div>\n");
        ...
        for (Object[] row : dsPhong) {
            ...
            if (listDV != null && !listDV.isEmpty()) {
                hasAnyDV = true;
                html.append("<h4 style='color: #475569; margin-top: 15px; margin-bottom: 5px;'>Phòng: " + maPhong + " - " + tenPhong + "</h4>\n");
                html.append("<table>\n<thead>\n<tr>\n<th>Tên dịch vụ</th>\n<th>Đơn giá</th>\n<th>Số lượng</th>\n<th>Thành tiền</th>\n</tr>\n</thead>\n<tbody>\n");
                for (DichVuSuDung dv : listDV) {
                    html.append("<tr>\n");
                    html.append("<td>" + (dv.getDichVu() != null ? dv.getDichVu().getTenDV() : "—") + "</td>\n");
                    html.append("<td>" + String.format("%,.0f đ", dv.getGiaDV()) + "</td>\n");
                    html.append("<td style='text-align: center;'>" + dv.getSoLuong() + "</td>\n");
                    html.append("<td style='text-align: right;'>" + String.format("%,.0f đ", dv.getGiaDV() * dv.getSoLuong()) + "</td>\n");
                    html.append("</tr>\n");
                }
                html.append("</tbody>\n</table>\n");
            }
        ...
        html.append("<div class='total-row'><div class='total-label'>Thuế VAT (10%):</div><div class='total-value'>"
                + String.format("%,.0f đ", (hd.getTienPhong() + hd.getTienDV()) * hd.getThueVAT()) + "</div></div>\n");
        html.append("<div class='total-row'><div class='total-label'>Tiền cọc:</div><div class='total-value'>- "
